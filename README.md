...
生成画像への差し替えを進行中（**4体・12枚が画像化完了**、残り5体は従来の SVG）。

### 現在の形態

- **画像化済み**（ひのこ・しずく・はっぱ・ぴかり）: 生成画像（`js/img/{hinoko,shizuku,happa,pikari}-{0,1,2}.png`）
...
残り5体を進める場合の手順。**以下はすべて実際に動かして確認した内容。**
...
12枚（4体）でオフラインキャッシュは約2.3MB。残り5体を入れると約5MBになる見込み。
