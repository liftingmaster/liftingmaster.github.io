...
生成画像への差し替えを進行中（**5体・15枚が画像化完了**、残り4体は従来の SVG）。

### 現在の形態

- **画像化済み**（ひのこ・しずく・はっぱ・ぴかり・もくも）: 生成画像（`js/img/{hinoko,shizuku,happa,pikari,mokumo}-{0,1,2}.png`）
- **その他5体**: コード生成 SVG（もくも・きらら・がんろ・こおる・かげろ）
...
残り4体を進める場合の手順。**以下はすべて実際に動かして確認した内容。**
...
| 2 | しずく | ✅ 完了（2026-07-28） | — |
| 3 | はっぱ | ✅ 完了（2026-07-28） | — |
| 4 | ぴかり | ✅ 完了（2026-08-01） | ✅ `docs/art-prompts/pikari.md` |
| 5 | もくも | ✅ 完了（2026-08-03） | — |
| 6 | きらら | ❌ SVG のまま | ❌ 未作成 |
| 7 | がんろ | ❌ SVG のまま | ❌ 未作成 |
| 8 | こおる | ❌ SVG のまま | ❌ 未作成 |
...
15枚（5体）でオフラインキャッシュは約3.0MB。残り4体を入れると約5MBになる見込み。
