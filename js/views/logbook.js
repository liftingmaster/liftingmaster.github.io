 ...
 * 同じ日の もくも が 510→0・Lv21→Lv1）。result.charChanges の全キャラを見る。
 *
 ...
 *
 * 進化を実現できるのは育成中のキャラだけになった（2026-07-28 の改訂）ので、
 * ここに並ぶカードはふつう1枚。複数枚に対応したままにしてあるのは、
 * 「保存は済んでいて evolvedStages も進んでいるのに、演出を見せそこねる」
 * 事故を構造的に起こさないため（ページ送りにすると、2枚目を見る前に
 * 下のナビを触られた時点でその演出は二度と出ない）。1枚にまとめて縦に並べる。
